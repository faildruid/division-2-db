...
def execfile(afile, globalz=None, localz=None):
    """Open the config file for adding to the execution."""
...
def install(name, config_path, default_settings, **kwargs):
    ...
    Args:
      name (str): Module name to handle specially (e.g., "division_config")
      config_path (str): Absolute path to the module in question (e.g., "/opt/division/division_config.py")
      default_settings (str): Settings module name to inherit settings from (e.g., "division.core.settings")
    """
    global installed
...
class LoganImporter:
    ...
    def __repr__(self):
        """Returns a more information-rich string representation of config_path."""
    ...
    def find_module(self, fullname, path=None):
        ...
        TODO(pat): find_module() API is deprecated, convert this to find_spec() instead.
        """
...
class LoganLoader:
    ...
    def load_module(self, fullname):
        ...
        FIXME(pat): load_module() API is deprecated, convert this to create_module()/exec_module() instead.
        """
        try:
